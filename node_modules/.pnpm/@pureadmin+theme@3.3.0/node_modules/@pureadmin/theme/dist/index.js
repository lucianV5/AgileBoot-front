...
var _themeUtils = require("@pureadmin/theme-utils");
...
const themePreprocessorPlugin = (options = {}) => {
  ...
  return {
    ...
    configResolved(resolvedConfig) {
      ...
      (0, _themeUtils.createPulignParamsFile)({
    ...
    transformIndexHtml(html) {
      ...
      if (arbitraryMode) {
        ...
        const loaderRsoleved = (0, _themeUtils.getCurrentPackRequirePath)();
        ...
        const themeResult = buildCommand !== "build" ? (0, _createSetCustomTheme.createSetCustomTheme)({
          ...
          buildCommand,
          cacheThemeStyleContent
        }) : (0, _themeUtils.getThemeStyleContent)();
    ...
    generateBundle() {
      ...
      if (extract && !arbitraryMode) {
        ...
        return (0, _themeUtils.extractThemeCss)({
          removeCssScopeName
        }).then(({
          themeCss
        }) => {
  ...
  return {
    ...
    handleHotUpdate({
      ...
      if (parentApi.getMultipleScopeVars().some(item => typeof item.path === "string" && file === item.path || Array.isArray(item.path) && item.path.some(p => p === file))) {
        (0, _themeUtils.removeThemeFiles)();
