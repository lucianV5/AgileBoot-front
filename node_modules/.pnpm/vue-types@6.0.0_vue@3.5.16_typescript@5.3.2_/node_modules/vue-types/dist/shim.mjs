import { t as typeDefaults, c as config, i as isPlainObject } from './shared/vue-types.8139b772.mjs';
  ...
  return (
    ...
    _a = class {
      ...
      static extend(props) {
        ...
        const extType = isPlainObject(type2) && type2.type ? null : type2;
        return createValidator(this, name, { type: extType }, getter, !!validate);
      }
    }, __publicField(_a, "defaults", {}), __publicField(_a, "sensibleDefaults"), __publicField(_a, "config", config), __publicField(_a, "oneOf", oneOf), __publicField(_a, "custom", custom), __publicField(_a, "instanceOf", instanceOf), __publicField(_a, "oneOfType", oneOfType), __publicField(_a, "arrayOf", arrayOf), __publicField(_a, "objectOf", objectOf), __publicField(_a, "shape", shape), __publicField(_a, "utils", {
      toType: type,
      validate: (...args) => !!args
    }), _a
  );
...
if (process.env.NODE_ENV !== "production") {
  config.silent === false && console.warn(
...
export { any, array, arrayOf, bool, config, createTypes, custom, VueTypes as default, fromType, func, instanceOf, integer, nullable, number, object, objectOf, oneOf, oneOfType, shape, string, symbol, toType, toValidableType, validateType };
